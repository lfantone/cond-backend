...
<body class="<?php print $classes.' lang-'.$language->language; ?>">
    <div class="mango-background-white">
   <div class="mango-background">
  ...
  <div id="page-wrapper"><div id="page">
    ...
    <div id="header"><div class="section clearfix">
      ...
      <?php print $header; ?>
        ...
        <div id="navigation" class="navigation-mango"><div class="section clearfix">
             <!--   <div class="text-menu"><span>Not a Consumer?</span> Go to Mango.org for:</div>-->
    ...
    <div id="main-wrapper"><div id="main" class="clearfix<?php if ($primary_links || $navigation) { print ' with-navigation'; } ?>">
      ...
      <div id="content" class="column"><div class="section">
        ...
        <?php if (mango_show_title($title)): ?>
            <?php
                $title_text='';
                if($node->type=='event'){
                    $title_text='<h1 class="title-top title events">'.t('Events').'</h1>';
                }else if($node->type=='page'){
                    if($node->field_video[0]['view']=='' && $node->field_image_multiple[0]['view']==''){
                        $title_text='<h1 class="title-top title title-page page-no-multimedia">'.$title.'</h1>';
                    }
                    if($node->nid==54){
                        $title_text='<h1 class="title-top title title-getcooking">'.t('Get Cooking with Mangos').'</h1>';
                    }
                }else if($node->type=='blog'){
                    $title_text='<h1 class="title-top title events">'.t('Let\'s Mango Blog').'</h1>';
                }else{
                        $title_text='<h1 class="title-top title title-'.$node->type.'">'.$title.'</h1>';
                    }
      ...
      <?php if($node->type!='blog' && arg(0)!='blog') { print $sidebar_second; } ?>
...
<?php if ($footer_message): ?>
        ...
        <?php endif; ?>
          ...
          </div><!-- cierra mango-background -->
    </div> <!-- cierra mango-background-white -->
</body>
</html>
