...
//		protected function Form_Validate() {}
		...
		protected function Form_Create() {
			...
			$strEditPageUrl = __BACKEND_DIR__ . '/version_edit.php';
			$this->dtgVersions->MetaAddEditLinkColumn($strEditPageUrl,  QApplication::Translate('Edit'),  QApplication::Translate('Edit'), QMetaControlArgumentType::QueryString);
			...
			$this->dtgVersions->MetaAddColumn(QQN::Version()->Nombre);
			$this->dtgVersions->MetaAddColumn(QQN::Version()->IdModeloObject->Nombre)->Name = "Modelo";
		}
	}
