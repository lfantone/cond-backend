...
if($_POST){	
	...
	$database->insert("servicios","nombre = '$nombre'");
	$new_id = $database->id;
	...
	if (isset($_POST['id_tarea'])){
		...
		foreach ($_POST['id_tarea'] as $tareas) {
			...
			foreach ($tareas as $id_tarea) {
				...
				$database->insert("servicios_tareas","id_servicio = $new_id, id_kilometro = " . $id_kilometro[$i] . ", id_tarea = $id_tarea");
	...
	if($_POST['id_ficha']){
		foreach($_POST['id_ficha'] as $ficha){
			$database->insert("fichas_servicios","id_ficha = $ficha, id_servicio = $new_id");
			$database->insert("fichas_servicios_tracking","id_ficha = $ficha, id_servicio = $new_id, action = 'I|CPSRV'");
	...
	foreach($fichas_relacionadas as $ficha){
		$database->insert("fichas_servicios","id_ficha = " . $ficha['id_ficha'] . ", id_servicio = $new_id");
...
<div class="container">
	<div class="content">
		<h1><a href="servicios.php">Servicios</a> &raquo; &quot;
			...
			&quot;</h1>
		<div class="form">
			<form action="servicios_copiar.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
				<table border="0" cellspacing="6" cellpadding="6">
					...
					<tr>
						<td>&nbsp;</td>
						<td><button type="submit" class="bold1">Copiar servicio</button>
