...
//		protected function Form_Validate() {}
      ...
      if (!$intIdPais = QApplication::QueryString('id_pais')) {
          QApplication::DisplayAlert("Pais no identificado, elija la opcion desde el menu");
          return;
      }

      $intEliminadas = Fichas::QueryCount(QQ::AndCondition(QQ::Equal(QQN::Fichas()->IdEstado, 1), QQ::Equal(QQN::Fichas()->IdPais, $intIdPais)));
      $intPublicadas = Fichas::QueryCount(QQ::AndCondition(QQ::Equal(QQN::Fichas()->IdEstado, 3), QQ::Equal(QQN::Fichas()->IdPais, $intIdPais)));
      $intBorradores = Fichas::QueryCount(QQ::AndCondition(QQ::Equal(QQN::Fichas()->IdEstado, 2), QQ::Equal(QQN::Fichas()->IdPais, $intIdPais)));
      $this->strCantEstados = sprintf('<span>Publicadas: %d</span><span>Eliminadas: %d</span><span>Borrador: %d</span>', $intPublicadas, $intEliminadas, $intBorradores);
