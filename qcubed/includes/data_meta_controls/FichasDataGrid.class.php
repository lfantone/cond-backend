...
//var_dump($this->Conditions); exit;
  ...
  public function addColumns() {
    ...
    $this->MetaAddColumn(QQN::Fichas()->IdPaisObject->Nombre)->Name = "Pais";
  ...
  public function MetaAddCopyLinkColumn($strLinkUrl, $strLinkHtml = 'Copiar', $strColumnTitle = 'Copiar', $intArgumentType = QMetaControlArgumentType::PathInfo) {
    ...
    $objPaisArray = Paises::LoadAll();
    foreach ($objPaisArray as $objPais) {
      $strHtml .= ' <a href="' . $strLinkUrl . '&id_pais=' . $objPais->Id . '">(' . substr($objPais->Nombre, 0, 3) . ')</a> -';
    }
    #$strHtml = $strLinkHtml . ' <a href="' . $strLinkUrl . '&id_pais=2">(ARG)</a> - '. '<a href="' . $strLinkUrl . '&id_pais=3">(MEX)</a>';
