<?php
	 ...
	 * listing a collection of Version objects.  It includes
	 ...
	 * 
	 */
	class VersionDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Version datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Version object, or it can be any QQNode extending from QQN::Version().
		 * 
		 ...
		 * sorting using two fields from the Version object.
		 *
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = Version::CountAll();
			}
			...
			// Set the DataSource to be a Query result from Version, given the clauses above
			$this->DataSource = Version::LoadAll($objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a Version-based QQNode.
		 * It will also verify that it is a proper Version-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Nombre': return QQN::Version()->Nombre;
