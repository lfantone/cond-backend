<?php
	 ...
	 * listing a collection of Encuestas objects.  It includes
	 ...
	 * 
	 */
	class EncuestasDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Encuestas datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Encuestas object, or it can be any QQNode extending from QQN::Encuestas().
		 * 
		 ...
		 * sorting using two fields from the Encuestas object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Encuestas
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = Encuestas::CountAll();
			}
			...
			// Set the DataSource to be a Query result from Encuestas, given the clauses above
			$this->DataSource = Encuestas::LoadAll($objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a Encuestas-based QQNode.
		 * It will also verify that it is a proper Encuestas-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'encuestas') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "encuestas".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::Encuestas()->Id;
				case 'Titulo': return QQN::Encuestas()->Titulo;
				case 'Opcion1': return QQN::Encuestas()->Opcion1;
				case 'Opcion2': return QQN::Encuestas()->Opcion2;
				case 'Opcion3': return QQN::Encuestas()->Opcion3;
				case 'Opcion4': return QQN::Encuestas()->Opcion4;
				case 'Opcion5': return QQN::Encuestas()->Opcion5;
				case 'Opcion6': return QQN::Encuestas()->Opcion6;
				case 'Valor1': return QQN::Encuestas()->Valor1;
				case 'Valor2': return QQN::Encuestas()->Valor2;
				case 'Valor3': return QQN::Encuestas()->Valor3;
				case 'Valor4': return QQN::Encuestas()->Valor4;
				case 'Valor5': return QQN::Encuestas()->Valor5;
				case 'Valor6': return QQN::Encuestas()->Valor6;
				case 'Estado': return QQN::Encuestas()->Estado;
				default: throw new QCallerException('Simple Property not found in EncuestasDataGrid content: ' . $mixContent);
