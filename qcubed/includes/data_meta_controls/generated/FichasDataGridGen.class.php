<?php
	 ...
	 * listing a collection of Fichas objects.  It includes
	 ...
	 * 
	 */
	class FichasDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Fichas datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Fichas object, or it can be any QQNode extending from QQN::Fichas().
		 * 
		 ...
		 * sorting using two fields from the Fichas object.
		 *
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = Fichas::CountAll();
			}
			...
			$this->DataSource = Fichas::LoadAll($objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a Fichas-based QQNode.
		 * It will also verify that it is a proper Fichas-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'IdPais': return QQN::Fichas()->IdPais;
				case 'IdPaisObject': return QQN::Fichas()->IdPaisObject;
				case 'IdSeguro': return QQN::Fichas()->IdSeguro;
				...
				case 'MotorShort': return QQN::Fichas()->MotorShort;
