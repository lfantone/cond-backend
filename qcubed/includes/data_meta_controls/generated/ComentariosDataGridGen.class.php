<?php
	 ...
	 * 
	 */
	class ComentariosDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Comentarios datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Comentarios object, or it can be any QQNode extending from QQN::Comentarios().
		 * 
		 ...
		 * sorting using two fields from the Comentarios object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Comentarios
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = Comentarios::CountAll();
			}
			...
			$this->DataSource = Comentarios::LoadAll($objClauses);
		}
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Nombre': return QQN::Comentarios()->Nombre;
				case 'Email': return QQN::Comentarios()->Email;
				case 'Comentarios': return QQN::Comentarios()->Comentarios;
				case 'IdNota': return QQN::Comentarios()->IdNota;
				case 'Fecha': return QQN::Comentarios()->Fecha;
