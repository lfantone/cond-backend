<?php
	 ...
	 * listing a collection of Wallpapers objects.  It includes
	 ...
	 * 
	 */
	class WallpapersDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Wallpapers datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Wallpapers object, or it can be any QQNode extending from QQN::Wallpapers().
		 * 
		 ...
		 * sorting using two fields from the Wallpapers object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Wallpapers
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = Wallpapers::CountAll();
			}
			...
			// Set the DataSource to be a Query result from Wallpapers, given the clauses above
			$this->DataSource = Wallpapers::LoadAll($objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a Wallpapers-based QQNode.
		 * It will also verify that it is a proper Wallpapers-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'wallpapers') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "wallpapers".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::Wallpapers()->Id;
				case 'Titulo': return QQN::Wallpapers()->Titulo;
				case 'Estado': return QQN::Wallpapers()->Estado;
				default: throw new QCallerException('Simple Property not found in WallpapersDataGrid content: ' . $mixContent);
