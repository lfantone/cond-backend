<?php
	 ...
	 * listing a collection of Modelo objects.  It includes
	 ...
	 * 
	 */
	class ModeloDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Modelo datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Modelo object, or it can be any QQNode extending from QQN::Modelo().
		 * 
		 ...
		 * sorting using two fields from the Modelo object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Modelo
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = Modelo::CountAll();
			}
			...
			$this->DataSource = Modelo::LoadAll($objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a Modelo-based QQNode.
		 * It will also verify that it is a proper Modelo-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'IdPais': return QQN::Modelo()->IdPais;
				case 'IdPaisObject': return QQN::Modelo()->IdPaisObject;
