<?php
	 ...
	 * listing a collection of MagazineNotas objects.  It includes
	 ...
	 * 
	 */
	class MagazineNotasDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this MagazineNotas datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the MagazineNotas object, or it can be any QQNode extending from QQN::MagazineNotas().
		 * 
		 ...
		 * sorting using two fields from the MagazineNotas object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from MagazineNotas
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = MagazineNotas::CountAll();
			}
			...
			// Set the DataSource to be a Query result from MagazineNotas, given the clauses above
			$this->DataSource = MagazineNotas::LoadAll($objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a MagazineNotas-based QQNode.
		 * It will also verify that it is a proper MagazineNotas-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'magazine_notas') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "magazine_notas".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::MagazineNotas()->Id;
				case 'Titulo': return QQN::MagazineNotas()->Titulo;
				case 'Subtitulo': return QQN::MagazineNotas()->Subtitulo;
				case 'Copete': return QQN::MagazineNotas()->Copete;
				case 'Contenido': return QQN::MagazineNotas()->Contenido;
				case 'FechaCreada': return QQN::MagazineNotas()->FechaCreada;
				case 'FechaPublicada': return QQN::MagazineNotas()->FechaPublicada;
				case 'Visitas': return QQN::MagazineNotas()->Visitas;
				case 'IdAutor': return QQN::MagazineNotas()->IdAutor;
				case 'Estado': return QQN::MagazineNotas()->Estado;
				case 'FechaAPublicar': return QQN::MagazineNotas()->FechaAPublicar;
				default: throw new QCallerException('Simple Property not found in MagazineNotasDataGrid content: ' . $mixContent);
