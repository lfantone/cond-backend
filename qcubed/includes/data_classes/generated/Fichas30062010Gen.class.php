<?php
	/**
	 * The abstract Fichas30062010Gen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the Fichas30062010 subclass which
	 * extends this Fichas30062010Gen class.
	 *
	 * Because subsequent re-code generations will overwrite any changes to this
	 * file, you should leave this file unaltered to prevent yourself from losing
	 * any information or code changes.  All customizations should be done by
	 * overriding existing or implementing new methods, properties and variables
	 * in the Fichas30062010 class.
	 * 
	 ...
	 */
	class Fichas30062010Gen extends QBaseClass {
		...
		/**
		 * Protected member variable that maps to the database PK Identity column fichas_30062010.id
		 * @var integer intId
		 */
		protected $intId;
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.id_marca
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.id_tipos
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.id_modelo
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.id_version
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.descripcion
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.precio
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.anio
		 * @var integer intAnio
		 */
		protected $intAnio;
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.combustible
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.cilindrada
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.cilindros
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.potencia_maxima
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.par_motor_torque
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.posicion
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.alimentacion
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.motor_short
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.valvulas
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.tipo
		 * @var string strTipo
		 */
		protected $strTipo;
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.marchas
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.traccion
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.velocidad_maxima
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.aceleracion_0_100
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.consumo_urbano
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.consumo_interurbano
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.consumo_mixto
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.puertas
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.plazas
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.filas_de_asientos
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.info_ejes
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.peso
		 * @var string strPeso
		 */
		protected $strPeso;
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.capacidad_baul
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.capacidad_tanque
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.capacidad_carga
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.frenos_delanteros
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.frenos_traseros
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.neumaticos
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.suspension_delantera
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.suspension_trasera
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.id_estado
		...
		/**
		 * Protected member variable that maps to the database column fichas_30062010.procesada
		...
		/**
		 * Load a Fichas30062010 from PK Info
		 * @param integer $intId
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return Fichas30062010
		 */
		public static function Load($intId, $objOptionalClauses = null) {
			// Use QuerySingle to Perform the Query
			return Fichas30062010::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::Fichas30062010()->Id, $intId)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			// Call Fichas30062010::QueryArray to perform the LoadAll query
			try {
				return Fichas30062010::QueryArray(QQ::All(), $objOptionalClauses);
		...
		/**
		 * Count all Fichas30062010s
		 * @return int
		 */
		public static function CountAll() {
			// Call Fichas30062010::QueryCount to perform the CountAll query
			return Fichas30062010::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objDatabase = Fichas30062010::GetDatabase();

			// Create/Build out the QueryBuilder object with Fichas30062010-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'fichas_30062010');
			Fichas30062010::GetSelectFields($objQueryBuilder);
			$objQueryBuilder->AddFromItem('fichas_30062010');
		...
		/**
		 * Static Qcubed Query method to query for a single Fichas30062010 object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return Fichas30062010 the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = Fichas30062010::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
			
			// Perform the Query, Get the First Row, and Instantiate a new Fichas30062010 object
			...
			if ($objQueryBuilder->ExpandAsArrayNodes) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = Fichas30062010::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNodes, $objToReturn, $objQueryBuilder->ColumnAliasArray);
					if ($objItem)
						$objToReturn[] = $objItem;					
				}
				...
				if(null === $objDbRow)
					return null;
				return Fichas30062010::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}

		/**
		 * Static Qcubed Query method to query for an array of Fichas30062010 objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return Fichas30062010[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return Fichas30062010::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNodes, $objQueryBuilder->ColumnAliasArray);
		}

		/**
		 * Static Qcubed Query method to query for a count of Fichas30062010 objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = Fichas30062010::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/fichas30062010', $strQuery);
			$cacheData = $objCache->GetData();
			
			if (!$cacheData || $blnForceUpdate) {
				$objDbResult = $objQueryBuilder->Database->Query($strQuery);
				$arrResult = Fichas30062010::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNodes, $objQueryBuilder->ColumnAliasArray);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this Fichas30062010
		...
		/**
		 * Instantiate a Fichas30062010 from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this Fichas30062010::InstantiateDbRow in order to perform
		...
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $strExpandAsArrayNodes = null, $arrPreviousItems = null, $strColumnAliasArray = array()) {
			...
			// Create a new instance of the Fichas30062010 object
			$objToReturn = new Fichas30062010();
			...
			if (!$strAliasPrefix)
				$strAliasPrefix = 'fichas_30062010__';
		...
		/**
		 * Instantiate an array of Fichas30062010s from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $strExpandAsArrayNodes = null, $strColumnAliasArray = null) {
			...
			if ($strExpandAsArrayNodes) {
				$objToReturn = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = Fichas30062010::InstantiateDbRow($objDbRow, null, $strExpandAsArrayNodes, $objToReturn, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
					}
				}
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = Fichas30062010::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
		...
		/**
		 * Load a single Fichas30062010 object,
		 * by Id Index(es)
		 * @param integer $intId
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return Fichas30062010
		*/
		...
		/**
		 * Load an array of Fichas30062010 objects,
		 * by IdMarca Index(es)
		...
		*/
		public static function LoadArrayByIdMarca($intIdMarca, $objOptionalClauses = null) {
			// Call Fichas30062010::QueryArray to perform the LoadArrayByIdMarca query
			try {
				return Fichas30062010::QueryArray(
					QQ::Equal(QQN::Fichas30062010()->IdMarca, $intIdMarca),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		/**
		 * Count Fichas30062010s
		 * by IdMarca Index(es)
		 * @param integer $intIdMarca
		 * @return int
		*/
		public static function CountByIdMarca($intIdMarca) {
			// Call Fichas30062010::QueryCount to perform the CountByIdMarca query
			return Fichas30062010::QueryCount(
				QQ::Equal(QQN::Fichas30062010()->IdMarca, $intIdMarca)
			);
		}
		...
		*/
		public static function LoadArrayByIdEstado($intIdEstado, $objOptionalClauses = null) {
			// Call Fichas30062010::QueryArray to perform the LoadArrayByIdEstado query
			try {
				return Fichas30062010::QueryArray(
					QQ::Equal(QQN::Fichas30062010()->IdEstado, $intIdEstado),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByIdEstado($intIdEstado) {
			// Call Fichas30062010::QueryCount to perform the CountByIdEstado query
			return Fichas30062010::QueryCount(
				QQ::Equal(QQN::Fichas30062010()->IdEstado, $intIdEstado)
			);
		}
		...
		*/
		public static function LoadArrayByIdTipos($intIdTipos, $objOptionalClauses = null) {
			// Call Fichas30062010::QueryArray to perform the LoadArrayByIdTipos query
			try {
				return Fichas30062010::QueryArray(
					QQ::Equal(QQN::Fichas30062010()->IdTipos, $intIdTipos),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByIdTipos($intIdTipos) {
			// Call Fichas30062010::QueryCount to perform the CountByIdTipos query
			return Fichas30062010::QueryCount(
				QQ::Equal(QQN::Fichas30062010()->IdTipos, $intIdTipos)
			);
		}
		...
		*/
		public static function LoadArrayByIdVersion($intIdVersion, $objOptionalClauses = null) {
			// Call Fichas30062010::QueryArray to perform the LoadArrayByIdVersion query
			try {
				return Fichas30062010::QueryArray(
					QQ::Equal(QQN::Fichas30062010()->IdVersion, $intIdVersion),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByIdVersion($intIdVersion) {
			// Call Fichas30062010::QueryCount to perform the CountByIdVersion query
			return Fichas30062010::QueryCount(
				QQ::Equal(QQN::Fichas30062010()->IdVersion, $intIdVersion)
			);
		}
		...
		*/
		public static function LoadArrayByIdModelo($intIdModelo, $objOptionalClauses = null) {
			// Call Fichas30062010::QueryArray to perform the LoadArrayByIdModelo query
			try {
				return Fichas30062010::QueryArray(
					QQ::Equal(QQN::Fichas30062010()->IdModelo, $intIdModelo),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByIdModelo($intIdModelo) {
			// Call Fichas30062010::QueryCount to perform the CountByIdModelo query
			return Fichas30062010::QueryCount(
				QQ::Equal(QQN::Fichas30062010()->IdModelo, $intIdModelo)
			);
		}
		...
		public function Save($blnForceInsert = false, $blnForceUpdate = false) {
			...
			try {
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$mixToReturn = $this->intId = $objDatabase->InsertId('fichas_30062010', 'id');
				} else {
		...
		/**
		 * Delete this Fichas30062010
		 * @return void
		 */
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this Fichas30062010 with an unset primary key.');
		...
		/**
		 * Truncate fichas_30062010 table
		 * @return void
		 */
		public static function Truncate() {
			...
			// Perform the Query
			$objDatabase->NonQuery('
				TRUNCATE `fichas_30062010`');
		}

		/**
		 * Reload this Fichas30062010 from the database.
		 * @return void
		 */
		public function Reload() {
			// Make sure we are actually Restored from the database
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved Fichas30062010 object.');

			// Reload the Object
			$objReloaded = Fichas30062010::Load($this->intId);
		...
		public static function GetSoapComplexTypeXml() {
			$strToReturn = '<complexType name="Fichas30062010"><sequence>';
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('Fichas30062010', $strComplexTypeArray)) {
				$strComplexTypeArray['Fichas30062010'] = Fichas30062010::GetSoapComplexTypeXml();
			}
		}
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, Fichas30062010::GetObjectFromSoapObject($objSoapObject));
		...
		public static function GetSoapArrayFromArray($objArray) {
			...
			foreach ($objArray as $objObject)
				array_push($objArrayToReturn, Fichas30062010::GetSoapObjectFromObject($objObject, true));
	...
	class QQNodeFichas30062010 extends QQNode {
		protected $strTableName = 'fichas_30062010';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'Fichas30062010';
		public function __get($strName) {
			switch ($strName) {
				case 'Id':
	...
	class QQReverseReferenceNodeFichas30062010 extends QQReverseReferenceNode {
		protected $strTableName = 'fichas_30062010';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'Fichas30062010';
		public function __get($strName) {
