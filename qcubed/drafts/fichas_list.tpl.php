<?php
	...
	$strPageTitle = QApplication::Translate('Fichases') . ' - ' . QApplication::Translate('List All');
...
?>
	...
	<div id="titleBar">
		...
		<h1><?php _t('Fichases'); ?></h1>
	</div>

	<?php $this->dtgFichases->Render(); ?>

	<p class="create">
		<a href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__) ?>/fichas_edit.php"><?php _t('Create a New'); ?> <?php _t('Fichas');?></a>
	</p>
