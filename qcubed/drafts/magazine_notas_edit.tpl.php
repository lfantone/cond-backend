<?php
	// This is the HTML template include file (.tpl.php) for the magazine_notas_edit.php
	// form DRAFT page.  Remember that this is a DRAFT.  It is MEANT to be altered/modified.

	// Be sure to move this out of the generated/ subdirectory before modifying to ensure that subsequent 
	// code re-generations do not overwrite your changes.

	$strPageTitle = QApplication::Translate('MagazineNotas') . ' - ' . $this->mctMagazineNotas->TitleVerb;
...
?>
	...
	<div id="titleBar">
		<h2><?php _p($this->mctMagazineNotas->TitleVerb); ?></h2>
		<h1><?php _t('MagazineNotas')?></h1>
	</div>
