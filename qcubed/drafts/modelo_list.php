...
//		protected function Form_Validate() {}
		...
		protected function Form_Create() {
			...
			$strEditPageUrl = __VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/modelo_edit.php';
			$this->dtgModelos->MetaAddEditLinkColumn($strEditPageUrl,  QApplication::Translate('Edit'),  QApplication::Translate('Edit'));
