<?php
	 ...
	 * @subpackage Drafts
	 */
	class MonedaPaisEditForm extends QForm {
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the MonedaPaisMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctMonedaPais = MonedaPaisMetaControl::CreateFromPathInfo($this);
			...
			$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(QApplication::Translate('Are you SURE you want to DELETE this') . ' ' . QApplication::Translate('MonedaPais') . '?'));
		...
		protected function RedirectToListPage() {
			QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/moneda_pais_list.php');
		}
	}

	// Go ahead and run this form object to render the page and its event handlers, implicitly using
	// moneda_pais_edit.tpl.php as the included HTML template file
	MonedaPaisEditForm::Run('MonedaPaisEditForm');
?>