<?php
	 ...
	 * @subpackage Drafts
	 */
	class NotasPaisesEditForm extends QForm {
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the NotasPaisesMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctNotasPaises = NotasPaisesMetaControl::CreateFromPathInfo($this);
			...
			$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(QApplication::Translate('Are you SURE you want to DELETE this') . ' ' . QApplication::Translate('NotasPaises') . '?'));
		...
		protected function RedirectToListPage() {
			QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/notas_paises_list.php');
		}
	}

	// Go ahead and run this form object to render the page and its event handlers, implicitly using
	// notas_paises_edit.tpl.php as the included HTML template file
	NotasPaisesEditForm::Run('NotasPaisesEditForm');
?>