...
//		protected function Form_Validate() {}
		...
		protected function Form_Create() {
			...
			$strEditPageUrl = __VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/autores_edit.php';
			$this->dtgAutoreses->MetaAddEditLinkColumn($strEditPageUrl,  QApplication::Translate('Edit'),  QApplication::Translate('Edit'));
