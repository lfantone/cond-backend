<?php
	 ...
	 * @subpackage Drafts
	 */
	class ModeloEditPanel extends QPanel {
		...
		public function __construct($objParentObject, $strClosePanelMethod, $intIdModelo = null, $strControlId = null) {
			...
			$this->strTemplate = 'ModeloEditPanel.tpl.php';
			$this->strClosePanelMethod = $strClosePanelMethod;

			// Construct the ModeloMetaControl
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctModelo = ModeloMetaControl::Create($this, $intIdModelo);
			...
			$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'),  QApplication::Translate('Modelo'))));
