<?php
	 ...
	 * @subpackage Drafts
	 */
	class MonedaEditPanel extends QPanel {
		...
		public function __construct($objParentObject, $strClosePanelMethod, $intIdMoneda = null, $strControlId = null) {
			// Call the Parent
			try {
			...
			$this->strTemplate = 'MonedaEditPanel.tpl.php';
			$this->strClosePanelMethod = $strClosePanelMethod;

			// Construct the MonedaMetaControl
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctMoneda = MonedaMetaControl::Create($this, $intIdMoneda);
			...
			$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'),  QApplication::Translate('Moneda'))));
