<?php
	// This is the HTML template include file (.tpl.php) for fichas_3_0_0_6_2_0_1_0EditPanel.
...
?>
	<div id="formControls">
		...
		<?php $_CONTROL->txtIdMarca->RenderWithName(); ?>

		<?php $_CONTROL->txtIdTipos->RenderWithName(); ?>

		<?php $_CONTROL->txtIdModelo->RenderWithName(); ?>

		<?php $_CONTROL->txtIdVersion->RenderWithName(); ?>
		...
		<?php $_CONTROL->txtIdEstado->RenderWithName(); ?>
