<?php
	 ...
	 * @subpackage Drafts
	 */
	class VersionEditPanel extends QPanel {
		...
		public function __construct($objParentObject, $strClosePanelMethod, $intIdVersion = null, $strControlId = null) {
			...
			$this->strTemplate = 'VersionEditPanel.tpl.php';
			$this->strClosePanelMethod = $strClosePanelMethod;

			// Construct the VersionMetaControl
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctVersion = VersionMetaControl::Create($this, $intIdVersion);
			...
			$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'),  QApplication::Translate('Version'))));
