<?php
	...
	$strPageTitle = QApplication::Translate('Items') . ' - ' . QApplication::Translate('List All');
...
?>
	...
	<p class="create">
		<a href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__) ?>/item_edit.php"><?php _t('Create a New'); ?> <?php _t('Item');?></a>
	</p>
