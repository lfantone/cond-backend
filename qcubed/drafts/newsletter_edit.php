<?php
	 ...
	 * @subpackage Drafts
	 */
	class NewsletterEditForm extends QForm {
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the NewsletterMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctNewsletter = NewsletterMetaControl::CreateFromPathInfo($this);

			// Call MetaControl's methods to create qcontrols based on Newsletter's data fields
			$this->lblId = $this->mctNewsletter->lblId_Create();
			$this->txtEmail = $this->mctNewsletter->txtEmail_Create();
			$this->calFecha = $this->mctNewsletter->calFecha_Create();
			$this->txtEstado = $this->mctNewsletter->txtEstado_Create();
			...
			$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(QApplication::Translate('Are you SURE you want to DELETE this') . ' ' . QApplication::Translate('Newsletter') . '?'));
		...
		protected function RedirectToListPage() {
			QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/newsletter_list.php');
		}
	}
