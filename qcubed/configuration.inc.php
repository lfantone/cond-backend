<?php
	...
	switch (SERVER_INSTANCE) {
		...
		case 'prod':
			 ...
			 */
			#define ('__DOCROOT__', '/var/chroot/home/content/69/5102269/html');
      define ('__DOCROOT__', '/var/www/vhosts/ip-50-63-84-244.ip.secureserver.net/conduciendo.com');
			define ('__VIRTUAL_DIRECTORY__', '');
			define ('__SUBDIRECTORY__', '/backend/qcubed');
			...
			define('DB_CONNECTION_1', serialize(array(
				'adapter' => 'MySqli5',
				'server' => 'conduciendodes.db.5102269.hostedresource.com',
				'port' => null,
				'database' => 'conduciendodes',
				'username' => 'conduciendodes',
				'password' => 'Mysql2009_des',
				'profiling' => false)));
...
//			define('ERROR_FRIENDLY_AJAX_MESSAGE', 'Oops!  An error has occurred.\r\n\r\nThe error was logged, and we will take a look into this right away.');
        define('__BACKEND_DIR__', '/backend');
			break;
	}
?>
