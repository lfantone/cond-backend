...
$id_video = htmlspecialchars($_GET['id_video']);
$notas_sql = "
	SELECT * FROM notas 
	WHERE titulo LIKE '%$keyword%' AND id NOT IN (SELECT id_nota FROM notas_videos WHERE id_video = $id_video) AND estado IN (2,3)
	ORDER BY id DESC
	LIMIT 0,60
";
