...
?>
    ...
    <?php $this->lstNotasPaises->RenderWithName(); ?>

    <?php $this->lstNotasMarcas->RenderWithName(); ?>

    <?php $this->lstNotasTipos->RenderWithName(); ?>

    <?php $this->lstCategoriasTipos->RenderWithName(); ?>
    <?php $this->btnMostrarImagenes->Render(); ?>
    <?php 
    if ($this->lstNotasImagenes) {
      $this->lstNotasImagenes->RenderWithName();
    }
    ?>
		...
		<?php $this->lstIdAutor->RenderWithName(); ?>
